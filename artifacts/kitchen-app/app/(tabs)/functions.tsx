...
function FunctionDetailPanel({ fnId }: DetailPanelProps) {
  ...
  const activeTimes: Array<{ label: string; time: string }> =
    ...
    <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
      <View style={{ padding: 20 }}>
        ...
        {(isActive || isUrgent) && (
          <View
            style={{
              ...
              paddingVertical: 8,
              borderRadius: 10,
              backgroundColor: isActive ? colors.accent + "18" : "#EF444415",
              borderWidth: 1,
              borderColor: isActive ? colors.accent + "50" : "#EF444440",
              flexDirection: "row",
              alignItems: "center",
              gap: 8,
            }}
          >
            <View
              style={{
                ...
                height: 8,
                borderRadius: 4,
                backgroundColor: isActive ? colors.accent : "#EF4444",
              }}
            />
            <Text
              style={{
                ...
                color: isActive ? colors.accent : "#EF4444",
        ...
        >
          ...
          >
            <Text
              style={{ fontSize: 11, fontFamily: "Inter_700Bold", color: tc }}
            >
              {fn.functionType}
            </Text>
          </View>
                  ...
                  >
                    <View
                      style={{
                        ...
                        paddingVertical: 5,
                        borderRadius: 7,
                        backgroundColor: past ? colors.secondary : tc + "20",
                        borderWidth: 1,
                        borderColor: past ? colors.border : tc + "50",
                        minWidth: 54,
                        alignItems: "center",
                      }}
                    >
                      <Text
                        style={{
                          fontSize: 13,
                          fontFamily: "Inter_700Bold",
                          color: past ? colors.mutedForeground : tc,
                        }}
                      >
                        {c.time}
                      </Text>
          ...
          >
            ...
            >
              <Feather
                name="check-square"
                size={12}
                color={prepPct >= 1 ? colors.accent : colors.warning}
              />
              <Text
                style={{
                  fontSize: 11,
              ...
              <Text
                style={{
                  fontSize: 12,
                  fontFamily: "Inter_700Bold",
                  color: prepPct >= 1 ? colors.accent : colors.primary,
                }}
              >
              ...
              >
                <View
                  style={{
                    ...
                    borderRadius: 3,
                    backgroundColor:
                      prepPct >= 1 ? colors.accent : colors.primary,
                    width: `${prepPct * 100}%`,
                  }}
                />
              </View>
                    ...
                    >
                      <View
                        style={{
                          height: 5,
                          borderRadius: 3,
                          backgroundColor: pct >= 1 ? colors.accent : tc2,
                          width: `${pct * 100}%`,
                        }}
                      />
                    </View>
...
export default function FunctionsScreen() {
  ...
  const visibleFunctions = React.useMemo(() => {
    ...
    return functions.filter(
      (f) =>
        currentMember.functionIds.includes(f.id) ||
        f.teamIds.includes(currentMember.id),
    );
      ...
      <>
        {visibleFunctions.length === 0 && (
          ...
          >
            ...
            >
              {isManager
                ? 'Tap "Add Event" to create your first function.'
                : isTeamLeader && hiddenForLeader.length > 0
                  ? "All functions are hidden."
                  : "Check with your manager for today's schedule."}
            </Text>
          </View>
        )}
        ...
        {isManager ? (
          visibleFunctions.map((fn) => {
            ...
            return (
              <GlassCard
                key={fn.id}
                style={cardStyle}
                accentColor={isSelected ? colors.primary : undefined}
              >
                <Pressable
                      ...
                      <>
                        ...
                        <Text
                          style={{
                            ...
                            fontFamily: "Inter_600SemiBold",
                            color:
                              prepPct >= 1 ? colors.accent : colors.warning,
                          }}
                        >
                  ...
                  <>
                    ...
                    >
                      ...
                      {fn.menu.length > 0 ? (
                          ...
                          {fn.menu.map((item, i) => (
                            <View
                              ...
                              style={{
                                ...
                                alignItems: "flex-start",
                                gap: 8,
                                marginBottom: i < fn.menu.length - 1 ? 5 : 0,
                              }}
                            >
                              <View
                                style={{
                        ...
                        >
                          ...
                          >
                            No menu added — tap Edit to add dishes
                          </Text>
                        </View>
                      )}
                      {dietaryReqs.length > 0 && (
                    ...
                    <View
                      style={{
                        ...
                        borderWidth: 1,
                        borderColor:
                          dietaryReqs.length > 0 ? "#F59E0B45" : colors.border,
                        backgroundColor:
                          dietaryReqs.length > 0
                            ? "#F59E0B06"
                            : colors.background,
                    ...
                    >
                      ...
                      {dietaryReqs.length === 0 ? (
                        ...
                        dietaryReqs.map((req, i) => {
                          const pct =
                            fn.guestCount > 0
                              ? Math.min(req.count / fn.guestCount, 1)
                              : 0;
                          const col = getDietaryColor(req.name);
                            ...
                            >
                              ...
                              {req.note ? (
                                ...
                                >
                                  ...
                                  >
                                    Chef's choice — tap Edit to add menu
                                    description
                                  </Text>
                                </View>
                              )}
          ...
          <>
            {visibleFunctions.map((fn) => {
              ...
              const fnTeamStaff = staff.filter(
                (st) => fn.teamIds.includes(st.id) && st.section === mySection,
              );
              const myLeader =
                fnTeamStaff.find((st) => !!st.teamLeadFor) ?? null;
              const dietaryReqs = fn.dietaryRequirements ?? [];
              ...
              return (
                <GlassCard key={fn.id} style={cardStyle}>
                  ...
                  >
                    ...
                    >
                      {fn.floor} · {fn.startTime}–{fn.endTime} · {fn.guestCount}{" "}
                      guests
                    </Text>
                  </View>
                  <View
                  ...
                  >
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      {myLeader ? (
                        ...
                        >
                          Leader: {myLeader.name}
                          {myLeader.phone ? ` · ${myLeader.phone}` : ""}
                        </Text>
                      ) : fn.chefInCharge ? (
                        <Text
                          style={{
                        ...
                        >
                          Chef in Charge: {fn.chefInCharge}
                        </Text>
                      ) : (
                        <Text
                          style={{
                        ...
                        >
                          Speak to your manager for team assignment
                        </Text>
                      )}
                    </View>
                    {hasDietary && (
                ...
                {hiddenForLeader.map((fn) => (
                  ...
                  >
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      >
                        {fn.startTime}–{fn.endTime} · {fn.room}
                      </Text>
                    </View>
                    <Text
                      style={{
          ...
          <View style={s.header}>
            <View style={{ flex: 1 }}>
              ...
              <Text style={s.subtitle}>
                {visibleFunctions.length} function
                {visibleFunctions.length !== 1 ? "s" : ""} showing
              </Text>
            </View>
            {isManager && (
              <Pressable
        ...
        <View style={{ flex: 1, backgroundColor: colors.background }}>
          {selectedFnId ? (
            ...
            >
              ...
              >
                Tap any event on the left to see details
              </Text>
            </View>
          )}
        </View>
