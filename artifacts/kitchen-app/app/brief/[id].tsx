...
export default function BriefScreen() {
  ...
  const s = StyleSheet.create({
    ...
    typeBadge:     { alignSelf: "flex-start", paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, backgroundColor: "#3B82F620", borderWidth: 1.5, borderColor: "#3B82F6", marginBottom: 10, marginHorizontal: 20 },
    typeBadgeText: { fontSize: 12, fontFamily: "Inter_700Bold", color: "#60A5FA" },
    ...
    whereEyebrow:  { fontSize: 10, fontFamily: "Inter_700Bold", color: "#22D3EE", letterSpacing: 1.4, textTransform: "uppercase", marginBottom: 6 },
    ...
    runTime:       { fontSize: 15, fontFamily: "Inter_700Bold", color: "#3B82F6", width: 56 },
