...
export default function BriefScreen() {
  ...
  const s = StyleSheet.create({
    ...
    menuTime: { fontSize: 13, fontFamily: "Inter_700Bold", color: "#3B82F6" },
    /* Dietary */
    dietaryCard: {
      borderRadius: 14,
    ...
    return (
      <View style={s.noData}>
        ...
        <Text style={s.noDataText}>
          Ask your team leader to show you the correct QR code, or check your
          shift assignment.
        </Text>
      </View>
    );
  ...
  const totalDietary =
    fn.dietaryRequirements?.reduce((n, r) => n + r.count, 0) ?? 0;
  ...
  return (
    <View style={s.root}>
      ...
      <View style={s.header}>
        ...
        <Text style={s.fnSub}>
          Today · {fn.startTime} until {fn.endTime}
        </Text>
      ...
      <ScrollView style={s.body} showsVerticalScrollIndicator={false}>
        ...
        {allSections.map((team) => {
          ...
          const leader =
            teamMembers.find((m) => m.teamLeadFor === team) ?? null;
          ...
          return (
            <View key={team} style={s.card}>
              <View style={s.teamHeader}>
                ...
                <View
                  style={[s.memberCountBadge, { backgroundColor: tc + "20" }]}
                >
                  <Text style={[s.memberCountText, { color: tc }]}>
                ...
                <View style={[s.leaderRow, { backgroundColor: tc + "08" }]}>
                  ...
                  {leader.phone && (
                    <View style={[s.phoneBtn, { backgroundColor: tc + "18" }]}>
                      ...
                      <Text style={[s.phoneText, { color: tc }]}>
                        {leader.phone}
                      </Text>
                    </View>
                  )}
              ...
              {others.map((m, idx) => (
                <View
                  ...
                  style={[
                    s.memberRow,
                    idx === others.length - 1 && { borderBottomWidth: 0 },
                  ]}
                >
        ...
        {unassigned.length > 0 && (
          <View style={s.card}>
            <View style={s.teamHeader}>
              ...
              <View
                style={[s.memberCountBadge, { backgroundColor: "#6B728020" }]}
              >
                <Text style={[s.memberCountText, { color: "#6B7280" }]}>
            ...
            {unassigned.map((m, idx) => (
              <View
                ...
                style={[
                  s.memberRow,
                  idx === unassigned.length - 1 && { borderBottomWidth: 0 },
                ]}
              >
            ...
            <View style={s.runCard}>
              {activeTimes.map((c, i) => (
                <View
                  ...
                  style={[
                    s.runRow,
                    i === activeTimes.length - 1 && { borderBottomWidth: 0 },
                  ]}
                >
          ...
          <>
            ...
            <View style={s.dietaryCard}>
              <View style={s.dietaryHeader}>
                ...
                <Text style={s.dietaryHeaderText}>
                  Check every plate. Ask your team leader if unsure.
                </Text>
              </View>
              {fn.dietaryRequirements.map((req, i) => (
                <View
                  ...
                  style={[
                    s.dietaryRow,
                    i === (fn.dietaryRequirements?.length ?? 0) - 1 && {
                      borderBottomWidth: 0,
                    },
                  ]}
                >
