        ...
        [
          { text: "Cancel", style: "cancel" },
          {
            ...
            onPress: () => {
              ...
              Linking.openURL(
                "mailto:hello@prepflows.app?subject=Enterprise Demo Request",
              );
            },
          },
        ],
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        {/* Hero */}
        <View
          style={{ paddingHorizontal: 24, paddingTop: 4, paddingBottom: 28 }}
        >
          <Text
            style={{
              fontSize: 11,
          ...
          {!subscription.isActive && (
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  Sign up now and your free month starts from your registration
                  date. No credit card charged until month 2.
                </Text>
              </View>
            </View>
          )}
        ...
        {PLAN_META.map((plan) => {
          ...
          const ctaTextColor = isEnterprise
            ? plan.color
            : isPro
              ? "#0D1117"
              : "#fff";
            ...
            >
              <View
                style={{
                  ...
                  borderBottomWidth: 1,
                  borderBottomColor: plan.color + "25",
                }}
              >
                <View
                  style={{
                ...
                >
                  ...
                  <View style={{ alignItems: "flex-end" }}>
                    {productsLoading && !plan.free && !isEnterprise ? (
                      ...
                      <Text
                        style={{
                          fontSize: isEnterprise ? 22 : 38,
                          fontFamily: "Inter_700Bold",
                          color: plan.color,
                          lineHeight: isEnterprise ? 28 : 44,
                        }}
                      >
                        {priceLabel}
                      </Text>
