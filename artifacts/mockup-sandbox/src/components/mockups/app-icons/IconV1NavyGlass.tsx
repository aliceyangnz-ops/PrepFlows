export function IconV1NavyGlass() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#030810", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20, fontFamily: "Inter, sans-serif" }}>
      <svg width={S} height={S} viewBox="0 0 300 300" style={{ borderRadius: R, display: "block", boxShadow: "0 32px 80px rgba(77,124,255,0.45), 0 8px 24px rgba(0,0,0,0.8)" }}>
        <defs>
          {/* Base background */}
        ...
        <g clipPath="url(#v1clip)">
          ...
          {/* Blobs */}
          <rect width="300" height="300" fill="url(#v1b1)" filter="url(#v1blur)" />
          <rect width="300" height="300" fill="url(#v1b2)" filter="url(#v1blur)" />
          <rect width="300" height="300" fill="url(#v1b3)" filter="url(#v1blur)" />
        ...
        <g transform="translate(30, 30) scale(2.4)">
          <path d={P} stroke="url(#v1p)" strokeWidth="11" fill="none" strokeLinecap="round" strokeLinejoin="round" filter="url(#v1pglow)" />
        </g>
      </svg>
      <div style={{ color: "#A0B4D0", fontSize: 15, fontWeight: 600, letterSpacing: "0.04em", textTransform: "uppercase" }}>Option 1 — Navy Glass</div>
    </div>
  );
}
