export function IconV2AuroraBlue() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#030810", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20, fontFamily: "Inter, sans-serif" }}>
      <svg width={S} height={S} viewBox="0 0 300 300" style={{ borderRadius: R, display: "block", boxShadow: "0 32px 80px rgba(99,102,241,0.5), 0 8px 24px rgba(0,0,0,0.8)" }}>
        <defs>
        ...
        <g clipPath="url(#v2clip)">
          ...
          <rect width="300" height="300" fill="url(#v2a1)" filter="url(#v2blur)" />
          <rect width="300" height="300" fill="url(#v2a2)" filter="url(#v2blur)" />
          <rect width="300" height="300" fill="url(#v2a3)" filter="url(#v2blur)" />
          <rect width="300" height="300" fill="url(#v2a4)" filter="url(#v2blur)" />
          <rect width="300" height="160" fill="url(#v2gloss)" />
        </g>
        <rect width="300" height="300" rx={R} fill="none" stroke="white" strokeOpacity="0.16" strokeWidth="1.5" />
        <g transform="translate(30, 30) scale(2.4)">
          <path d={P} stroke="url(#v2p)" strokeWidth="11" fill="none" strokeLinecap="round" strokeLinejoin="round" filter="url(#v2pglow)" />
        </g>
      </svg>
      <div style={{ color: "#A0B4D0", fontSize: 15, fontWeight: 600, letterSpacing: "0.04em", textTransform: "uppercase" }}>Option 2 — Aurora Blue</div>
    </div>
  );
}
