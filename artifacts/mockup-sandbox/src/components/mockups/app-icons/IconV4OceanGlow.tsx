export function IconV4OceanGlow() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#030810", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20, fontFamily: "Inter, sans-serif" }}>
      <svg width={S} height={S} viewBox="0 0 300 300" style={{ borderRadius: R, display: "block", boxShadow: "0 32px 80px rgba(0,224,255,0.4), 0 8px 24px rgba(0,0,0,0.8)" }}>
        <defs>
        ...
        <g clipPath="url(#v4clip)">
          ...
          <rect width="300" height="300" fill="url(#v4b1)" filter="url(#v4blur)" />
          <rect width="300" height="300" fill="url(#v4b2)" filter="url(#v4blur)" />
          <rect width="300" height="300" fill="url(#v4b3)" filter="url(#v4blur)" />
          <rect width="300" height="300" fill="url(#v4b4)" filter="url(#v4blur)" />
          <rect width="300" height="160" fill="url(#v4gloss)" />
        </g>
        <rect width="300" height="300" rx={R} fill="none" stroke="white" strokeOpacity="0.15" strokeWidth="1.5" />
        <g transform="translate(30, 30) scale(2.4)">
          <path d={P} stroke="url(#v4p)" strokeWidth="11" fill="none" strokeLinecap="round" strokeLinejoin="round" filter="url(#v4pglow)" />
        </g>
      </svg>
      <div style={{ color: "#A0B4D0", fontSize: 15, fontWeight: 600, letterSpacing: "0.04em", textTransform: "uppercase" }}>Option 4 — Ocean Glow</div>
    </div>
  );
}
