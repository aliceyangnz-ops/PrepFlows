...
const CalendarIcon = ({ size, strokeWidth, className }: any) => (
  <svg
    className={className}
    width={size}
    height={size}
        ...
        <div className="mb-6 pb-20">
          ...
          <div className="relative border-l border-zinc-800 ml-3 space-y-6">
            <div className="relative pl-6">
              <CheckCircle2
                className="absolute -left-[11px] top-0 text-emerald-500 bg-zinc-950"
                size={22}
              />
              <div className="text-xs font-bold text-zinc-500 mb-1">
                6:00 AM
              </div>
              <div className="font-semibold text-emerald-50 text-base">
                Mise en place
              </div>
              <div className="text-zinc-400 text-sm mt-1">
                Vegetables chopped, stocks started.
              </div>
            </div>

            <div className="relative pl-6">
              <PlayCircle
                className="absolute -left-[11px] top-0 text-amber-500 bg-zinc-950"
                size={22}
              />
              <div className="text-xs font-bold text-amber-500 mb-1">
                9:00 AM
              </div>
              <div className="font-semibold text-amber-50 text-base">
                Main Prep
              </div>
              <div className="text-amber-200/70 text-sm mt-1">
                Proteins sealed, sauces finishing.
              </div>
            ...
            <div className="relative pl-6">
              <Circle
                className="absolute -left-[11px] top-0 text-zinc-600 bg-zinc-950"
                size={22}
              />
              <div className="text-xs font-bold text-zinc-500 mb-1">
                11:30 AM
              </div>
              <div className="font-semibold text-zinc-300 text-base">
                Service Set Up
              </div>
              <div className="text-zinc-500 text-sm mt-1">
                Pass arranged, hot boxes on.
              </div>
            </div>
