    ...
    >
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <span style={{ fontSize: "14px", color: "#8B949E" }}>
              Hartley Wedding · Ballroom A · Sat 17 May
            </span>
          </div>
          <button
            style={{
        ...
        <div>
          ...
          <p
            style={{ fontSize: "14px", color: "#8B949E", margin: "0 0 24px 0" }}
          >
            Tap to add — kitchen staff will see these during service
          </p>
        ...
        >
          ...
          <span style={{ fontSize: "13px", color: "#EF4444", opacity: 0.8 }}>
