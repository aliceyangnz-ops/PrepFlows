        ...
        <div style={styles.kpiGrid}>
          ...
          <div style={styles.card}>
            <div style={styles.kpiValueRow}>
              ...
              <span style={{...styles.kpiTrend, color: '#22C55E'}}>↑ 2 vs last week</span>
            </div>
          ...
          <div style={styles.card}>
            <div style={styles.kpiValueRow}>
              <span style={{...styles.kpiValue, color: '#F0F6FC'}}>2,847</span>
              <span style={{...styles.kpiTrend, color: '#22C55E'}}>↑ 12%</span>
            </div>
          ...
          <div style={styles.card}>
            <div style={styles.kpiValueRow}>
              <span style={{...styles.kpiValue, color: '#F97316'}}>$148k</span>
        ...
        <div style={styles.listCard}>
          ...
          <div style={styles.listItem}>
            <div style={styles.listItemRow1}>
              ...
              <div style={{...styles.pill, background: 'rgba(34,197,94,0.1)', color: '#22C55E'}}>
                ● On Time
              </div>
            </div>
            <div>
          ...
          <div style={styles.listItem}>
            ...
            <div>
              <div style={styles.progressBg}>
                <div style={{...styles.progressFill, width: '100%', background: '#22C55E'}}></div>
              </div>
