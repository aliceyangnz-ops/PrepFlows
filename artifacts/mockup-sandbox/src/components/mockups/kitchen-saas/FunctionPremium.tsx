...
export function FunctionPremium() {
  ...
  const runSheetItems = [
    {
      time: "09:00",
      name: "Kitchen Briefing",
      category: "SETUP",
      status: "done",
    },
    {
      time: "10:30",
      name: "Mise en Place — Entrée",
      category: "PREP",
      status: "done",
    },
    {
      time: "11:00",
      name: "Dietary Meals Prepared",
      category: "PREP",
      status: "done",
    },
    {
      time: "14:00",
      name: "Final Mise en Place — Main",
      category: "PREP",
      status: "active",
    },
    {
  ...
  return (
    ...
    >
      ...
      {/* STATS ROW */}
      <div
        style={{ display: "flex", gap: 8, padding: "0 20px", marginBottom: 32 }}
      >
        {[
                  ...
                  style={{
                    ...
                    border:
                      item.status === "upcoming"
                        ? `2px solid ${tokens.textSecondary}`
                        : "none",
                    marginTop: 3,
                    zIndex: 2,
                  }}
