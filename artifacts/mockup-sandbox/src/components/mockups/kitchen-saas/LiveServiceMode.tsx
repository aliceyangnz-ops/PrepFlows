    ...
    >
      ...
      <div style={{ padding: "20px" }}>
        ...
        >
          ...
          <div
            style={{ color: "#8B949E", fontSize: "14px", marginBottom: "24px" }}
          >
          ...
          >
            ...
            >
              ...
              <div
                style={{ fontSize: "11px", color: "#F0F6FC", fontWeight: 700 }}
              >
                Main
              </div>
            </div>
        ...
        <div style={{ marginBottom: "32px" }}>
          ...
          >
            <div style={{ display: "flex", gap: "12px", fontSize: "14px" }}>
              <div style={{ color: "#484F58", fontFamily: "monospace" }}>
                18:47
              </div>
            ...
            >
              ...
              <div style={{ color: "#F0F6FC", fontWeight: 500 }}>
                Hot: Fire main confirmed
              </div>
            </div>
            <div style={{ display: "flex", gap: "12px", fontSize: "14px" }}>
              <div style={{ color: "#484F58", fontFamily: "monospace" }}>
