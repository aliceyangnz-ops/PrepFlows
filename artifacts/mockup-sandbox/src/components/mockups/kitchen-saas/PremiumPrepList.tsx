        ...
        >
          ...
          >
            <div>
              ...
              >
                ...
                <span style={{ fontSize: 13, color: "#8B949E" }}>
                  12 tasks · <span style={{ color: "#EF4444" }}>3 overdue</span>
                </span>
              </div>
            ...
            <svg
              ...
              style={{
                transform:
                  expandedSection === "hot" ? "rotate(180deg)" : "none",
          ...
          >
            <div>
              ...
              >
                ...
                <span style={{ color: "#484F58", fontSize: 12 }}>·</span>
                <span style={{ fontSize: 13, color: "#8B949E" }}>
                  8 tasks · <span style={{ color: "#EF4444" }}>1 overdue</span>
                </span>
              </div>
            ...
            <svg
              ...
              style={{
                transform:
                  expandedSection === "cold" ? "rotate(180deg)" : "none",
                transition: "transform 0.2s",
              }}
            >
              <polyline points="6 9 12 15 18 9"></polyline>
        ...
        >
          ...
          >
            ...
            <svg
              ...
              style={{
                transform:
                  expandedSection === "pastry" ? "rotate(180deg)" : "none",
                transition: "transform 0.2s",
              }}
            >
              <polyline points="6 9 12 15 18 9"></polyline>
