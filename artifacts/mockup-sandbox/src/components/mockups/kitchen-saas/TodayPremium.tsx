    ...
    >
      ...
      <div className="px-5 pt-12 pb-6 flex justify-between items-end">
        ...
        <div className="flex items-center bg-[#F97316]/10 px-3 py-1.5 rounded-full border border-[#F97316]/20">
          <div
            className="w-2 h-2 rounded-full bg-[#F97316] mr-2"
            style={{ animation: "pulse-ring 2s infinite" }}
          />
          <span className="text-[#F97316] text-[11px] font-bold tracking-widest uppercase">
            3 Live
          </span>
        </div>
      </div>
      ...
      <div className="px-5 mb-8">
        <div className="bg-[#161B22] border border-[#21262D] rounded-xl relative overflow-hidden shadow-2xl">
          ...
          <div className="p-5 pl-6">
            <p className="text-[#484F58] text-[10px] font-bold tracking-widest uppercase mb-3">
              Next Service
            </p>
            <h2 className="text-[18px] font-bold text-[#F0F6FC] mb-2 leading-tight">
              Hartley Wedding — Ballroom A
            </h2>
      ...
      <div className="px-5 mb-8">
        <h3 className="text-[#F0F6FC] text-sm font-semibold mb-4 tracking-wide">
          Today's Functions
        </h3>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="bg-[#161B22] border border-[#21262D] rounded-lg p-4 relative overflow-hidden flex flex-col justify-center min-h-[80px]">
            <div className="flex justify-between items-start mb-2">
              <div className="flex items-center gap-2">
                <div
                  ...
                  style={{ animation: "pulse-ring 2s infinite" }}
                />
                <h4 className="text-[15px] font-semibold text-[#F0F6FC] leading-none">
                  Hartley Wedding
                </h4>
              </div>
            ...
            <div className="text-xs text-[#8B949E] pl-4 font-medium">
              Ballroom A <span className="mx-1 text-[#484F58]">·</span> 6:30pm{" "}
              <span className="mx-1 text-[#484F58]">·</span> 190 covers
            </div>
          </div>
          ...
          <div className="bg-[#161B22] border border-[#21262D] rounded-lg p-4 relative overflow-hidden flex flex-col justify-center min-h-[80px]">
            ...
            <div className="text-xs text-[#8B949E] pl-4 font-medium">
              Dining Room <span className="mx-1 text-[#484F58]">·</span> 12:00pm{" "}
              <span className="mx-1 text-[#484F58]">·</span> 45 covers
            </div>
          </div>
          ...
          <div className="bg-[#0D1117] border border-[#21262D]/50 opacity-60 rounded-lg p-4 relative overflow-hidden flex flex-col justify-center min-h-[80px]">
            <div className="flex justify-between items-start mb-2">
              <div className="flex items-center gap-2">
                ...
                <h4 className="text-[15px] font-semibold text-[#8B949E] leading-none line-through decoration-[#484F58]">
                  St Mary's Morning Tea
                </h4>
              </div>
            ...
            <div className="text-xs text-[#484F58] pl-4 font-medium">
              Garden Pavilion <span className="mx-1 text-[#21262D]">·</span>{" "}
              9:00am <span className="mx-1 text-[#21262D]">·</span> 60 covers
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="px-5 mb-8">
        <div className="flex justify-between items-end mb-3">
          <h3 className="text-[#F0F6FC] text-sm font-semibold tracking-wide">
            Prep Progress
          </h3>
        ...
        <div className="flex gap-2">
          <div className="bg-[#161B22] border border-[#21262D] text-[#8B949E] text-xs font-medium px-3 py-1.5 rounded-md">
            <strong className="text-[#F0F6FC] font-semibold mr-1">42</strong> of
            57 tasks
          </div>
          <div className="bg-[#EF4444]/10 border border-[#EF4444]/20 text-[#EF4444] text-xs font-semibold px-3 py-1.5 rounded-md flex items-center gap-1.5">
            <div className="w-1.5 h-1.5 rounded-full bg-[#EF4444]" />3 overdue
          </div>
        </div>
      </div>
        ...
        <div className="flex gap-3 overflow-x-auto pb-4 no-scrollbar -mx-5 px-5">
          ...
          <div className="bg-[#F97316]/5 border border-[#F97316]/20 rounded-lg p-3 min-w-[200px] flex-shrink-0">
            <div className="flex items-center gap-1.5 mb-2">
              ...
              <h4 className="text-[#F97316] text-xs font-bold uppercase tracking-wider">
                Allergy Check
              </h4>
            </div>
            <p className="text-[#8B949E] text-xs leading-relaxed font-medium">
              Hartley:{" "}
              <strong className="text-[#F0F6FC]">3 nut allergies</strong> —
              verify menu
            </p>
          </div>
          ...
          <div className="bg-[#EAB308]/5 border border-[#EAB308]/20 rounded-lg p-3 min-w-[200px] flex-shrink-0">
            <div className="flex items-center gap-1.5 mb-2">
              ...
              <h4 className="text-[#EAB308] text-xs font-bold uppercase tracking-wider">
                Short Staff
              </h4>
            </div>
            <p className="text-[#8B949E] text-xs leading-relaxed font-medium">
              PM shift: <strong className="text-[#F0F6FC]">2 staff</strong>{" "}
              called in sick
            </p>
          </div>
        </div>
