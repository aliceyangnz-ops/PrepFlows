    ...
    >
      ...
      <Orb
        style={{
          ...
          height: 360,
          background:
            "radial-gradient(circle, rgba(6,182,212,0.14) 0%, transparent 68%)",
          filter: "blur(48px)",
        }}
      />
      <Orb
        style={{
          ...
          height: 280,
          background:
            "radial-gradient(ellipse, rgba(129,140,248,0.10) 0%, transparent 68%)",
          filter: "blur(64px)",
        }}
      />
        ...
        >
          <button
            ...
            style={{
              ...
              transition: "opacity 0.2s, transform 0.2s",
              boxShadow:
                "0 0 28px rgba(59,130,246,0.32), 0 0 56px rgba(6,182,212,0.12)",
            }}
            onMouseEnter={(e) => {
    ...
    >
      <Orb
        style={{
          ...
          height: 500,
          background:
            "radial-gradient(circle, rgba(129,140,248,0.1) 0%, transparent 68%)",
          filter: "blur(60px)",
        }}
      />
            ...
            <FadeUp key={f.title} delay={i * 0.09}>
              <div
                ...
                style={{
                  ...
                  transition:
                    "background 0.25s, border-color 0.25s, transform 0.25s",
                  transform:
              ...
              >
                ...
                <div
                  style={{
                    ...
                    marginBottom: 28,
                    boxShadow:
                      hovered === i ? "0 0 20px rgba(59,130,246,0.3)" : "none",
      ...
      >
        ...
        <FadeUp>
          <div>
            ...
            >
              Replace spreadsheets, paper run sheets, and WhatsApp groups with a
              unified system. Every team member — from head chef to casual staff
            ...
            >
              Role-based access means managers see everything, team leaders
              control their sections, and staff see exactly what they need to do
              their job.
            </p>
          </div>
        </FadeUp>
    ...
    >
      ...
      <Orb
        style={{
          ...
          height: 400,
          background:
            "radial-gradient(ellipse, rgba(59,130,246,0.14) 0%, rgba(6,182,212,0.08) 40%, transparent 70%)",
          filter: "blur(60px)",
        }}
      />
      ...
      >
          ...
          >
            <button
              ...
              style={{
                ...
                transition: "opacity 0.2s, transform 0.2s",
                boxShadow:
                  "0 0 40px rgba(59,130,246,0.4), 0 0 80px rgba(6,182,212,0.15)",
            ...
            <button
              ...
              style={{
                background: "transparent",
                color: hoverSecondary ? C.text : C.muted,
                fontSize: 15,
                fontWeight: 500,
                padding: "16px 44px",
                borderRadius: 9999,
        ...
        <FadeUp delay={0.28}>
          <div
            style={{ marginTop: 88, display: "flex", justifyContent: "center" }}
          >
            <div
              style={{
                position: "relative",
            ...
            >
              ...
              >
                PrepFlows replaced three separate systems and a wall of paper
                run sheets. Service has never been smoother.
              </p>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: "#52525B" }}>
                    Executive Chef, Sofitel Melbourne
                  </div>
                </div>
              </div>
            </div>
...
function Footer() {
  ...
  return (
    <footer
      style={{ borderTop: `1px solid ${C.border}`, padding: "40px 28px" }}
    >
      <div
        style={{
          maxWidth: 1100,
      ...
      >
        ...
        <span style={{ fontSize: 12, color: "#3F3F46" }}>
          © {new Date().getFullYear()} PrepFlows
        </span>
      </div>
    </footer>
  );
...
export default function Home() {
  usePageMeta({
    ...
    description:
      "The operating system for professional kitchens. Manage functions, prep lists, rosters, and live service — all in one place. Free trial, no credit card required.",
