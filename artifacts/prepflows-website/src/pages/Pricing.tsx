...
function IconShield({ size = 28 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 28 28" fill="none">
      <path
        d="M14 3 L24 7 L24 13 C24 19 19 23.5 14 25.5 C9 23.5 4 19 4 13 L4 7 Z"
        stroke="url(#pg-icon-grad)"
        strokeWidth="1.8"
...
function IconRefresh({ size = 28 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 28 28" fill="none">
      ...
      />
      <path
        d="M6 14 A8 8 0 0 1 21 8.5"
        stroke="url(#pg-icon-grad)"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
      <polyline
        points="22,9 22,14 17,14"
        stroke="url(#pg-icon-grad)"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export default function Pricing() {
  usePageMeta({
    ...
    description:
      "Simple, honest pricing for PrepFlows. Start free, no credit card required. Upgrade to Pro for $49/month or Team for $199/month. All plans include iOS, Android & Web.",
  ...
  function handleCta(plan: (typeof PLANS)[0]) {
    ...
    navigate(
      `/app?plan=${plan.priceId}&billing=${annual ? "annual" : "monthly"}`,
    );
  }
    ...
    >
      ...
      >
        ...
        <p className="text-lg max-w-xl mx-auto" style={{ color: "#8B949E" }}>
          No per-seat fees. No hidden extras. Every staff member on your team
          uses the app under a single venue subscription.
        </p>
        ...
        <div className="flex items-center justify-center gap-4 mt-8">
          <span
            ...
            style={{ color: annual ? "#8B949E" : "#F0F6FC" }}
          >
            Monthly
          </span>
          <button
          ...
          <span
            className="text-sm font-semibold"
            style={{ color: annual ? "#F0F6FC" : "#8B949E" }}
          >
            Annual
            <span
      ...
      <div className="max-w-6xl mx-auto px-6 pb-20">
              ...
              >
                {plan.badge && (
                  <div
                    ...
                    style={{
                      background: plan.highlight ? YELLOW : `${plan.color}25`,
                    ...
                    {plan.features.map((f, i) => (
                      <li key={i} className="flex items-center gap-3 text-sm">
                        <span className="flex-shrink-0 text-base">
                          {f.included ? (
                            <span
                              style={{ color: plan.highlight ? YELLOW : GREEN }}
                            >
                              ✓
                            </span>
                          ) : (
                        ...
                        <span
                          style={{ color: f.included ? "#F0F6FC" : "#484F58" }}
                        >
                          {f.text}
                        </span>
                      </li>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(59,130,246,0.07) 0%, rgba(6,182,212,0.04) 50%, rgba(129,140,248,0.06) 100%)",
        ...
        >
          ...
          <div className="p-10 text-center">
            ...
            <p
              ...
              style={{ color: "#8B949E" }}
            >
              Talk to our team about custom pricing, dedicated onboarding, API
              access, and SLA support for groups.
            </p>
            <a
